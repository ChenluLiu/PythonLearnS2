...
#    surface_sz = 480        # Desired physical surface size, in pixels
    ...
    # Load an image to draw. gif, jpg, png, etc.
...
#   some_color = (255,0,0)
    ...
    while True:
        ...
        # Update game objects and data structures
        frame_count += 1
        ...
        # Put a red rectangle on the main surface
        main_surface.fill((255,0,0),(300,100,150,90))

        # Copy the image to the surface, at (x, y) position
